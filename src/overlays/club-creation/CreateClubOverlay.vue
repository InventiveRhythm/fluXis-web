            ...
            <div class="content flex flex-col w-panel gap-4 p-6 bg-dark-3 rounded-2xl drop-shadow-lg" ref="content">
                ...
                <div class="flex text-left gap-4">
                    ...
                    <div class="relative">
                        ...
                        <input ref="name" class="w-[332px] p-4 pl-12 bg-dark-2 rounded-xl focus:outline-none"
                            placeholder="Name" type="text" maxlength="16">
                    </div>
                </div>
