...
<template>
    <Transition name="context-fade">
        <div :class="`fixed flex flex-col flex-1 transition-all duration-75 bg-dark-2 rounded-md overflow-hidden ${react.right ? '-translate-x-full origin-top-right' : 'origin-top-left'}`"
